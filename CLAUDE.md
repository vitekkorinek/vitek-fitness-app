...
> **▶️ RESUME HERE — `b388367` COMMITTED & PUSHED (July 2026): Do Mode card-notes rework, BOTH SIDES. Trainer built + device-reviewed across ~10 iterations; client mirrored same-day on Vitek's go-ahead. Typecheck baseline 29. Client side not yet device-reviewed.**
