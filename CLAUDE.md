...
> - **NEWEST — UNCOMMITTED (July 24 2026, TWO waves same day): client Training-tab RESTRUCTURE + "Workout card style" promoted to a PERMANENT setting — and in WAVE 2 taken APP-WIDE, BOTH SIDES (trainer entry point in Account → APPEARANCE; every cover card incl. the week strips obeys it). Device-review-pending — nothing from July 24 has been seen on device yet.**
